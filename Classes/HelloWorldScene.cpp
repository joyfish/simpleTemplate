...
void HelloWorld::menuCloseCallback(Ref* pSender)
{
	...
	sendMessageToServer(CMD_Constant::ACTION_TEST1);
...
void HelloWorld::sendMessageToServer(int actionId)
{
...
void HelloWorld::receiveMessageFromServer(SmartMessageData * data)
{
